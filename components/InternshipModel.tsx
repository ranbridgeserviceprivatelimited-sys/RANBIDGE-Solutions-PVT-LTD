  ...
  return (
    <section id="model" className="py-24 bg-transparent page-break">
      <div className="container mx-auto px-6">
        <div className="bg-white border border-slate-200 shadow-xl rounded-[3rem] overflow-hidden">
          <div className="grid lg:grid-cols-2">
            <div className="p-12 lg:p-20 space-y-8">
              <h2 className="text-blue-600 font-bold uppercase tracking-wider text-sm">Internship Model</h2>
            ...
            <div className="bg-slate-50 p-8 lg:p-12 grid grid-cols-1 md:grid-cols-2 gap-4 border-l border-slate-200">
              {modelSpecs.map((spec, index) => (
                <div key={index} className="bg-white p-6 rounded-2xl border border-slate-200 hover:border-blue-500/50 transition-colors shadow-sm">
                  ...
                  <h4 className="text-slate-900 font-bold text-lg mb-1">{spec.value}</h4>
                  <p className="text-slate-600 text-sm">{spec.detail}</p>
                </div>
              ))}
            </div>
          </div>
