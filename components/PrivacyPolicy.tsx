      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 font-brand">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Privacy Commitment</h2>
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Data Collection & Storage</h2>
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">Voluntary Information Sharing</h2>
                  <div className="space-y-3 text-slate-600">
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-4">User Agreement</h2>
                  <div className="space-y-3 text-slate-600">
              ...
              <div className="space-y-3 text-slate-600">
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-4">
                  <div>
                    ...
                    <p>ranbidgesolutionspvtltd@gmail.com</p>
                  </div>
                  <div>
